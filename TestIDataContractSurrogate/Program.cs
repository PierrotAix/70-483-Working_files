...
namespace TestIDataContractSurrogate
{
    class program
     {
        /// <summary>
        /// 
        /// To illustrate answer "Create a class that implement IDateContractSurrogate and pass an instance of this class
        /// to the DataContractJsonSerializer constructor.
        /// The IDataContractSurrogate interface allows tou to override serialization specified by the DataContract and
        /// DataMember attributes. (in our example an Account class was defined in a separate assembly over which 
        /// you have no control).
        /// Fournit les méthodes nécessaires pour substituer un type à un autre par le DataContractSerializer 
        /// pendant la sérialisation, la désérialisation, l’exportation et l’importation de documents de schéma XML (XSD).
        /// https://docs.microsoft.com/fr-fr/dotnet/api/system.runtime.serialization.idatacontractsurrogate?view=netframework-4.7.2#exemples
        /// </summary>
        ...
        static void Main(string[] args)
            ...
            /*
            GetDataContractType invoked
                     type name: Employee
            GetObjectToSerialize Invoked
                     type name: TestIDataContractSurrogate.Employee
                     target type: Employee
            GetDataContractType invoked
                     type name: Person
                     returning PersonSurrogated
            GetObjectToSerialize Invoked
                     type name: TestIDataContractSurrogate.Person
                     target type: PersonSurrogated
                     returning PersonSurrogated
            Serialization succeeded.
            Trying to deserialize with surrogate.
            GetDataContractType invoked
                     type name: Employee
            GetDataContractType invoked
                     type name: Person
                     returning PersonSurrogated
            GetDeserializedObject invoked
            GetDeserializedObject invoked
            ...
            Deserialized Person data:
                     ...
                     Date Hired: 14/10/1999
                     Salary: 33000
            Press Enter to end or continue
